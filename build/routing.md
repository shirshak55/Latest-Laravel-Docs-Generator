...
- [Basic Routing](#routing-basic-routing)
    - [Redirect Routes](#routing-redirect-routes)
    - [View Routes](#routing-view-routes)
- [Route Parameters](#routing-route-parameters)
    - [Required Parameters](#routing-required-parameters)
    - [Optional Parameters](#routing-parameters-optional-parameters)
    - [Regular Expression Constraints](#routing-parameters-regular-expression-constraints)
- [Named Routes](#routing-named-routes)
- [Route Groups](#routing-route-groups)
    - [Middleware](#routing-route-group-middleware)
    - [Namespaces](#routing-route-group-namespaces)
    - [Sub-Domain Routing](#routing-route-group-sub-domain-routing)
    - [Route Prefixes](#routing-route-group-prefixes)
    - [Route Name Prefixes](#routing-route-group-name-prefixes)
- [Route Model Binding](#routing-route-model-binding)
    - [Implicit Binding](#routing-implicit-binding)
    - [Explicit Binding](#routing-explicit-binding)
- [Fallback Routes](#routing-fallback-routes)
- [Rate Limiting](#routing-rate-limiting)
- [Form Method Spoofing](#routing-form-method-spoofing)
- [Accessing The Current Route](#routing-accessing-the-current-route)
...
Any HTML forms pointing to `POST`, `PUT`, or `DELETE` routes that are defined in the `web` routes file should include a CSRF token field. Otherwise, the request will be rejected. You can read more about CSRF protection in the [CSRF documentation](#{{version}}/csrf):
...
#### Global Constraints {#routing-parameters-global-constraints}
