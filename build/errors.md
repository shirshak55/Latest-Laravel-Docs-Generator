...
- [The Exception Handler](#errors-the-exception-handler)
    - [Report Method](#errors-report-method)
    - [Render Method](#errors-render-method)
    - [Reportable & Renderable Exceptions](#errors-renderable-exceptions)
- [HTTP Exceptions](#errors-http-exceptions)
    - [Custom HTTP Error Pages](#errors-custom-http-error-pages)
...
### The Report Method {#errors-report-method}
...
> {tip} Instead of making a lot of `instanceof` checks in your `report` method, consider using [reportable exceptions](#{{version}}/errors-renderable-exceptions)
...
### The Render Method {#errors-render-method}
