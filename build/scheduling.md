...
- [Introduction](#scheduling-introduction)
- [Defining Schedules](#scheduling-defining-schedules)
    - [Scheduling Artisan Commands](#scheduling-scheduling-artisan-commands)
    - [Scheduling Queued Jobs](#scheduling-scheduling-queued-jobs)
    - [Scheduling Shell Commands](#scheduling-scheduling-shell-commands)
    - [Schedule Frequency Options](#scheduling-schedule-frequency-options)
    - [Timezones](#scheduling-timezones)
    - [Preventing Task Overlaps](#scheduling-preventing-task-overlaps)
    - [Running Tasks On One Server](#scheduling-running-tasks-on-one-server)
    - [Maintenance Mode](#scheduling-maintenance-mode)
- [Task Output](#scheduling-task-output)
- [Task Hooks](#scheduling-task-hooks)
...
In addition to scheduling Closure calls, you may also schedule [Artisan commands](#{{version}}/artisan) and operating system commands. For example, you may use the `command` method to schedule an Artisan command using either the command's name or class:
...
The `job` method may be used to schedule a [queued job](#{{version}}/queues). This method provides a convenient way to schedule jobs without using the `call` method to manually create Closures to queue the job:
...
Using the `emailOutputTo` method, you may e-mail the output to an e-mail address of your choice. Before e-mailing the output of a task, you should configure Laravel's [e-mail services](#{{version}}/mail):
