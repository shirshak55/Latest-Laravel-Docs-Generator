...
- [Introduction](#authorization-introduction)
- [Gates](#authorization-gates)
    - [Writing Gates](#authorization-writing-gates)
    - [Authorizing Actions](#authorization-authorizing-actions-via-gates)
    - [Intercepting Gate Checks](#authorization-intercepting-gate-checks)
- [Creating Policies](#authorization-creating-policies)
    - [Generating Policies](#authorization-generating-policies)
    - [Registering Policies](#authorization-registering-policies)
- [Writing Policies](#authorization-writing-policies)
    - [Policy Methods](#authorization-policy-methods)
    - [Methods Without Models](#authorization-methods-without-models)
    - [Policy Filters](#authorization-policy-filters)
- [Authorizing Actions Using Policies](#authorization-authorizing-actions-using-policies)
    - [Via The User Model](#authorization-via-the-user-model)
    - [Via Middleware](#authorization-via-middleware)
    - [Via Controller Helpers](#authorization-via-controller-helpers)
    - [Via Blade Templates](#authorization-via-blade-templates)
...
You may generate a policy using the `make:policy` [artisan command](#{{version}}/artisan). The generated policy will be placed in the `app/Policies` directory. If this directory does not exist in your application, Laravel will create it for you:
...
> {tip} All policies are resolved via the Laravel [service container](#{{version}}/container), allowing you to type-hint any needed dependencies in the policy's constructor to have them automatically injected.
