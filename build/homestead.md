...
- [Introduction](#homestead-introduction)
- [Installation & Setup](#homestead-installation-and-setup)
    - [First Steps](#homestead-first-steps)
    - [Configuring Homestead](#homestead-configuring-homestead)
    - [Launching The Vagrant Box](#homestead-launching-the-vagrant-box)
    - [Per Project Installation](#homestead-per-project-installation)
    - [Installing MariaDB](#homestead-installing-mariadb)
    - [Installing MongoDB](#homestead-installing-mongodb)
    - [Installing Elasticsearch](#homestead-installing-elasticsearch)
    - [Installing Neo4j](#homestead-installing-neo4j)
    - [Aliases](#homestead-aliases)
- [Daily Usage](#homestead-daily-usage)
    - [Accessing Homestead Globally](#homestead-accessing-homestead-globally)
    - [Connecting Via SSH](#homestead-connecting-via-ssh)
    - [Connecting To Databases](#homestead-connecting-to-databases)
    - [Database Backups](#homestead-database-backups)
    - [Adding Additional Sites](#homestead-adding-additional-sites)
    - [Environment Variables](#homestead-environment-variables)
    - [Configuring Cron Schedules](#homestead-configuring-cron-schedules)
    - [Configuring Mailhog](#homestead-configuring-mailhog)
    - [Configuring Minio](#homestead-configuring-minio)
    - [Ports](#homestead-ports)
    - [Sharing Your Environment](#homestead-sharing-your-environment)
    - [Multiple PHP Versions](#homestead-multiple-php-versions)
    - [Web Servers](#homestead-web-servers)
    - [Mail](#homestead-mail)
- [Network Interfaces](#homestead-network-interfaces)
- [Updating Homestead](#homestead-updating-homestead)
- [Provider Specific Settings](#homestead-provider-specific-settings)
    - [VirtualBox](#homestead-provider-specific-virtualbox)
...
### Included Software {#homestead-included-software}
...
Once configured, Homestead will export your databases to `mysql_backup` and `postgres_backup` directories when the `vagrant destroy` command is executed. These directories can be found in the folder where you cloned Homestead or in the root of your project if you are using the [per project installation](#homestead-per-project-installation) method.
...
#### Site Types {#homestead-site-types}
...
#### Site Parameters {#homestead-site-parameters}
...
Laravel provides a convenient way to [schedule Cron jobs](#{{version}}/scheduling) by scheduling a single `schedule:run` Artisan command to be run every minute. The `schedule:run` command will examine the job schedule defined in your `App\Console\Kernel` class to determine which jobs should be run.
