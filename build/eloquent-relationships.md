...
- [Introduction](#eloquent-relationships-introduction)
- [Defining Relationships](#eloquent-relationships-defining-relationships)
    - [One To One](#eloquent-relationships-one-to-one)
    - [One To Many](#eloquent-relationships-one-to-many)
    - [One To Many (Inverse)](#eloquent-relationships-one-to-many-inverse)
    - [Many To Many](#eloquent-relationships-many-to-many)
    - [Has Many Through](#eloquent-relationships-has-many-through)
    - [Polymorphic Relations](#eloquent-relationships-polymorphic-relations)
    - [Many To Many Polymorphic Relations](#eloquent-relationships-many-to-many-polymorphic-relations)
- [Querying Relations](#eloquent-relationships-querying-relations)
    - [Relationship Methods Vs. Dynamic Properties](#eloquent-relationships-relationship-methods-vs-dynamic-properties)
    - [Querying Relationship Existence](#eloquent-relationships-querying-relationship-existence)
    - [Querying Relationship Absence](#eloquent-relationships-querying-relationship-absence)
    - [Counting Related Models](#eloquent-relationships-counting-related-models)
- [Eager Loading](#eloquent-relationships-eager-loading)
    - [Constraining Eager Loads](#eloquent-relationships-constraining-eager-loads)
    - [Lazy Eager Loading](#eloquent-relationships-lazy-eager-loading)
- [Inserting & Updating Related Models](#eloquent-relationships-inserting-and-updating-related-models)
    - [The `save` Method](#eloquent-relationships-the-save-method)
    - [The `create` Method](#eloquent-relationships-the-create-method)
    - [Belongs To Relationships](#eloquent-relationships-updating-belongs-to-relationships)
    - [Many To Many Relationships](#eloquent-relationships-updating-many-to-many-relationships)
- [Touching Parent Timestamps](#eloquent-relationships-touching-parent-timestamps)
...
Eloquent relationships are defined as methods on your Eloquent model classes. Since, like Eloquent models themselves, relationships also serve as powerful [query builders](#{{version}}/queries), defining relationships as methods provides powerful method chaining and querying capabilities. For example, we may chain additional constraints on this `posts` relationship:
...
You are able to use any of the [query builder](#{{version}}/queries) methods on the relationship, so be sure to explore the query builder documentation to learn about all of the methods that are available to you.
...
Dynamic properties are "lazy loading", meaning they will only load their relationship data when you actually access them. Because of this, developers often use [eager loading](#eloquent-relationships-eager-loading) to pre-load relationships they know will be accessed after loading the model. Eager loading provides a significant reduction in SQL queries that must be executed to load a model's relations.
...
In this example, Eloquent will only eager load posts where the post's `title` column contains the word `first`. Of course, you may call other [query builder](#{{version}}/queries) methods to further customize the eager loading operation:
...
> {tip} Before using the `create` method, be sure to review the documentation on attribute [mass assignment](#{{version}}/eloquent-mass-assignment).
...
#### Default Models {#eloquent-relationships-default-models}
