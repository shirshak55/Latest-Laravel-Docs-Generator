# Laravel Socialite {#socialite}

- [Introduction](#socialite-introduction)
- [Installation](#socialite-installation)
- [Configuration](#socialite-configuration)
- [Routing](#socialite-routing)
- [Optional Parameters](#socialite-optional-parameters)
- [Access Scopes](#socialite-access-scopes)
- [Stateless Authentication](#socialite-stateless-authentication)
- [Retrieving User Details](#socialite-retrieving-user-details)
