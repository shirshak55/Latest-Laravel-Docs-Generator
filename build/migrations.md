...
- [Generating Migrations](#migrations-generating-migrations)
- [Migration Structure](#migrations-migration-structure)
- [Running Migrations](#migrations-running-migrations)
    - [Rolling Back Migrations](#migrations-rolling-back-migrations)
- [Tables](#migrations-tables)
    - [Creating Tables](#migrations-creating-tables)
    - [Renaming / Dropping Tables](#migrations-renaming-and-dropping-tables)
- [Columns](#migrations-columns)
    - [Creating Columns](#migrations-creating-columns)
    - [Column Modifiers](#migrations-column-modifiers)
    - [Modifying Columns](#migrations-modifying-columns)
    - [Dropping Columns](#migrations-dropping-columns)
- [Indexes](#migrations-indexes)
    - [Creating Indexes](#migrations-creating-indexes)
    - [Renaming Indexes](#migrations-renaming-indexes)
    - [Dropping Indexes](#migrations-dropping-indexes)
    - [Foreign Key Constraints](#migrations-foreign-key-constraints)

## Introduction {#migrations-introduction}

Migrations are like version control for your database, allowing your team to easily modify and share the application's database schema. Migrations are typically paired with Laravel's schema builder to easily build your application's database schema. If you have ever had to tell a teammate to manually add a column to their local database schema, you've faced the problem that database migrations solve.

The Laravel `Schema` [facade](#{{version}}/facades) provides database agnostic support for creating and manipulating tables across all of Laravel's supported database systems.
...
Within both of these methods you may use the Laravel schema builder to expressively create and modify tables. To learn about all of the methods available on the `Schema` builder, [check out its documentation](#migrations-creating-tables). For example, this migration example creates a `flights` table:
...
> {note} If you are using the [Homestead virtual machine](#{{version}}/homestead), you should run this command from within your virtual machine.
...
Of course, when creating the table, you may use any of the schema builder's [column methods](#migrations-creating-columns) to define the table's columns.
...
Below is a list of all the available column modifiers. This list does not include the [index modifiers](#migrations-creating-indexes):
