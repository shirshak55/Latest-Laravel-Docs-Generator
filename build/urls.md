...
- [Introduction](#urls-introduction)
- [The Basics](#urls-the-basics)
    - [Generating Basic URLs](#urls-generating-basic-urls)
    - [Accessing The Current URL](#urls-accessing-the-current-url)
- [URLs For Named Routes](#urls-urls-for-named-routes)
    - [Signed URLs](#urls-signed-urls)
- [URLs For Controller Actions](#urls-urls-for-controller-actions)
- [Default Values](#urls-default-values)
...
Each of these methods may also be accessed via the `URL` [facade](#{{version}}/facades):
...
You will often be generating URLs using the primary key of [Eloquent models](#{{version}}/eloquent). For this reason, you may pass Eloquent models as parameter values. The `route` helper will automatically extract the model's primary key:
