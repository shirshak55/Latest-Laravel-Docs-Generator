...
- [Introduction](#filesystem-introduction)
- [Configuration](#filesystem-configuration)
    - [The Public Disk](#filesystem-the-public-disk)
    - [The Local Driver](#filesystem-the-local-driver)
    - [Driver Prerequisites](#filesystem-driver-prerequisites)
    - [Caching](#filesystem-caching)
- [Obtaining Disk Instances](#filesystem-obtaining-disk-instances)
- [Retrieving Files](#filesystem-retrieving-files)
    - [Downloading Files](#filesystem-downloading-files)
    - [File URLs](#filesystem-file-urls)
    - [File Metadata](#filesystem-file-metadata)
- [Storing Files](#filesystem-storing-files)
    - [File Uploads](#filesystem-file-uploads)
    - [File Visibility](#filesystem-file-visibility)
- [Deleting Files](#filesystem-deleting-files)
- [Directories](#filesystem-directories)
- [Custom Filesystems](#filesystem-custom-filesystems)
...
> {note} Remember, if you are using the `local` driver, all files that should be publicly accessible should be placed in the `storage/app/public` directory. Furthermore, you should [create a symbolic link](#filesystem-the-public-disk) at `public/storage` which points to the `storage/app/public` directory.
...
Next, you should create a [service provider](#{{version}}/providers) such as `DropboxServiceProvider`. In the provider's `boot` method, you may use the `Storage` facade's `extend` method to define the custom driver:
