...
- [Writing Commands](#artisan-writing-commands)
    - [Generating Commands](#artisan-generating-commands)
    - [Command Structure](#artisan-command-structure)
    - [Closure Commands](#artisan-closure-commands)
- [Defining Input Expectations](#artisan-defining-input-expectations)
    - [Arguments](#artisan-arguments)
    - [Options](#artisan-options)
    - [Input Arrays](#artisan-input-arrays)
    - [Input Descriptions](#artisan-input-descriptions)
- [Command I/O](#artisan-command-io)
    - [Retrieving Input](#artisan-retrieving-input)
    - [Prompting For Input](#artisan-prompting-for-input)
    - [Writing Output](#artisan-writing-output)
- [Registering Commands](#artisan-registering-commands)
- [Programmatically Executing Commands](#artisan-programmatically-executing-commands)
    - [Calling Commands From Other Commands](#artisan-calling-commands-from-other-commands)
...
Let's take a look at an example command. Note that we are able to inject any dependencies we need into the command's constructor or `handle` method. The Laravel [service container](#{{version}}/container) will automatically inject all dependencies type-hinted in the constructor or `handle` method:
...
Even though this file does not define HTTP routes, it defines console based entry points (routes) into your application. Within this file, you may define all of your Closure based routes using the `Artisan::command` method. The `command` method accepts two arguments: the [command signature](#artisan-defining-input-expectations) and a Closure which receives the commands arguments and options:
...
In addition to receiving your command's arguments and options, command Closures may also type-hint additional dependencies that you would like resolved out of the [service container](#{{version}}/container):
...
#### Options With Values {#artisan-options-with-values}
...
#### Option Shortcuts {#artisan-option-shortcuts}
...
You may also manually register commands by adding its class name to the `$commands` property of your `app/Console/Kernel.php` file. When Artisan boots, all the commands listed in this property will be resolved by the [service container](#{{version}}/container) and registered with Artisan:
...
Using the `queue` method on the `Artisan` facade, you may even queue Artisan commands so they are processed in the background by your [queue workers](#{{version}}/queues). Before using this method, make sure you have configured your queue and are running a queue listener:
