...
- [Defining Translation Strings](#localization-defining-translation-strings)
    - [Using Short Keys](#localization-using-short-keys)
    - [Using Translation Strings As Keys](#localization-using-translation-strings-as-keys)
- [Retrieving Translation Strings](#localization-retrieving-translation-strings)
    - [Replacing Parameters In Translation Strings](#localization-replacing-parameters-in-translation-strings)
    - [Pluralization](#localization-pluralization)
- [Overriding Package Language Files](#localization-overriding-package-language-files)
...
Of course if you are using the [Blade templating engine](#{{version}}/blade), you may use the `{{ }}` syntax to echo the translation string or use the `@lang` directive:
