...
- [Introduction](#blade-introduction)
- [Template Inheritance](#blade-template-inheritance)
    - [Defining A Layout](#blade-defining-a-layout)
    - [Extending A Layout](#blade-extending-a-layout)
- [Components & Slots](#blade-components-and-slots)
- [Displaying Data](#blade-displaying-data)
    - [Blade & JavaScript Frameworks](#blade-blade-and-javascript-frameworks)
- [Control Structures](#blade-control-structures)
    - [If Statements](#blade-if-statements)
    - [Switch Statements](#blade-switch-statements)
    - [Loops](#blade-loops)
    - [The Loop Variable](#blade-the-loop-variable)
    - [Comments](#blade-comments)
    - [PHP](#blade-php)
- [Including Sub-Views](#blade-including-sub-views)
    - [Rendering Views For Collections](#blade-rendering-views-for-collections)
- [Stacks](#blade-stacks)
- [Service Injection](#blade-service-injection)
- [Extending Blade](#blade-extending-blade)
    - [Custom If Statements](#blade-custom-if-statements)
...
If needed, you may specify the [authentication guard](#{{version}}/authentication) that should be checked when using the `@auth` and `@guest` directives:
...
> {tip} When looping, you may use the [loop variable](#blade-the-loop-variable) to gain valuable information about the loop, such as whether you are in the first or last iteration through the loop.
...
The `@inject` directive may be used to retrieve a service from the Laravel [service container](#{{version}}/container). The first argument passed to `@inject` is the name of the variable the service will be placed into, while the second argument is the class or interface name of the service you wish to resolve:
