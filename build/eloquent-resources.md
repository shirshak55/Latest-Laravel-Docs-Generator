# Eloquent: API Resources {#eloquent-resources}

- [Introduction](#eloquent-resources-introduction)
- [Generating Resources](#eloquent-resources-generating-resources)
- [Concept Overview](#eloquent-resources-concept-overview)
- [Writing Resources](#eloquent-resources-writing-resources)
    - [Data Wrapping](#eloquent-resources-data-wrapping)
    - [Pagination](#eloquent-resources-pagination)
    - [Conditional Attributes](#eloquent-resources-conditional-attributes)
    - [Conditional Relationships](#eloquent-resources-conditional-relationships)
    - [Adding Meta Data](#eloquent-resources-adding-meta-data)
- [Resource Responses](#eloquent-resources-resource-responses)
...
> {tip} If you have not read the [concept overview](#eloquent-resources-concept-overview), you are highly encouraged to do so before proceeding with this documentation.
...
> {tip} If you would like to include relationships only when they have already been loaded, check out the documentation on [conditional relationships](#eloquent-resources-conditional-relationships).
...
If you would like to disable the wrapping of the outer-most resource, you may use the `withoutWrapping` method on the base resource class. Typically, you should call this method from your `AppServiceProvider` or another [service provider](#{{version}}/providers) that is loaded on every request to your application:
