# Compiling Assets (Laravel Mix) {#mix}

- [Introduction](#mix-introduction)
- [Installation & Setup](#mix-installation)
- [Running Mix](#mix-running-mix)
- [Working With Stylesheets](#mix-working-with-stylesheets)
    - [Less](#mix-less)
    - [Sass](#mix-sass)
    - [Stylus](#mix-stylus)
    - [PostCSS](#mix-postcss)
    - [Plain CSS](#mix-plain-css)
    - [URL Processing](#mix-url-processing)
    - [Source Maps](#mix-css-source-maps)
- [Working With JavaScript](#mix-working-with-scripts)
    - [Vendor Extraction](#mix-vendor-extraction)
    - [React](#mix-react)
    - [Vanilla JS](#mix-vanilla-js)
    - [Custom Webpack Configuration](#mix-custom-webpack-configuration)
- [Copying Files & Directories](#mix-copying-files-and-directories)
- [Versioning / Cache Busting](#mix-versioning-and-cache-busting)
- [Browsersync Reloading](#mix-browsersync-reloading)
- [Environment Variables](#mix-environment-variables)
- [Notifications](#mix-notifications)
...
After generating the versioned file, you won't know the exact file name. So, you should use Laravel's global `mix` function within your [views](#{{version}}/views) to load the appropriately hashed asset. The `mix` function will automatically determine the current name of the hashed file:
