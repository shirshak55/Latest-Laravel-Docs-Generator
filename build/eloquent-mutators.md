...
- [Introduction](#eloquent-mutators-introduction)
- [Accessors & Mutators](#eloquent-mutators-accessors-and-mutators)
    - [Defining An Accessor](#eloquent-mutators-defining-an-accessor)
    - [Defining A Mutator](#eloquent-mutators-defining-a-mutator)
- [Date Mutators](#eloquent-mutators-date-mutators)
- [Attribute Casting](#eloquent-mutators-attribute-casting)
    - [Array & JSON Casting](#eloquent-mutators-array-and-json-casting)

## Introduction {#eloquent-mutators-introduction}

Accessors and mutators allow you to format Eloquent attribute values when you retrieve or set them on model instances. For example, you may want to use the [Laravel encrypter](#{{version}}/encryption) to encrypt a value while it is stored in the database, and then automatically decrypt the attribute when you access it on an Eloquent model.

In addition to custom accessors and mutators, Eloquent can also automatically cast date fields to [Carbon](https://github.com/briannesbitt/Carbon) instances or even [cast text fields to JSON](#eloquent-mutators-attribute-casting).
...
### Date Casting {#eloquent-mutators-date-casting}

When using the `date` or `datetime` cast type, you may specify the date's format. This format will be used when the [model is serialized to an array or JSON](#{{version}}/eloquent-serialization):
