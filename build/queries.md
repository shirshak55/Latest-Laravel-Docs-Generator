# Database: Query Builder {#queries}

- [Introduction](#queries-introduction)
- [Retrieving Results](#queries-retrieving-results)
    - [Chunking Results](#queries-chunking-results)
    - [Aggregates](#queries-aggregates)
- [Selects](#queries-selects)
- [Raw Expressions](#queries-raw-expressions)
- [Joins](#queries-joins)
- [Unions](#queries-unions)
- [Where Clauses](#queries-where-clauses)
    - [Parameter Grouping](#queries-parameter-grouping)
    - [Where Exists Clauses](#queries-where-exists-clauses)
    - [JSON Where Clauses](#queries-json-where-clauses)
- [Ordering, Grouping, Limit, & Offset](#queries-ordering-grouping-limit-and-offset)
- [Conditional Clauses](#queries-conditional-clauses)
- [Inserts](#queries-inserts)
- [Updates](#queries-updates)
    - [Updating JSON Columns](#queries-updating-json-columns)
    - [Increment & Decrement](#queries-increment-and-decrement)
- [Deletes](#queries-deletes)
- [Pessimistic Locking](#queries-pessimistic-locking)
...
### Raw Methods {#queries-raw-methods}
...
For more advanced `having` statements, see the [`havingRaw`](#queries-raw-methods) method.
