...
- [Environment Configuration](#configuration-environment-configuration)
    - [Environment Variable Types](#configuration-environment-variable-types)
    - [Retrieving Environment Configuration](#configuration-retrieving-environment-configuration)
    - [Determining The Current Environment](#configuration-determining-the-current-environment)
- [Accessing Configuration Values](#configuration-accessing-configuration-values)
- [Configuration Caching](#configuration-configuration-caching)
- [Maintenance Mode](#configuration-maintenance-mode)
...
The current application environment is determined via the `APP_ENV` variable from your `.env` file. You may access this value via the `environment` method on the `App` [facade](#{{version}}/facades):
